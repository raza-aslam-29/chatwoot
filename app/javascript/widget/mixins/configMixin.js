export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.channelXWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.channelXWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.channelXWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.channelXWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.channelXWebChannel.preChatFormOptions || {};
