...
export default {
  ...
  computed: {
    ...
    allowedLoginMethods() {
      return window.channelxConfig.allowedLoginMethods || ['email'];
    },
    showGoogleOAuth() {
      return (
        this.allowedLoginMethods.includes('google_oauth') &&
        Boolean(window.channelxConfig.googleOAuthClientId)
      );
    },
    showSignupLink() {
      return window.channelxConfig.signupEnabled === 'true';
    },
    showSamlLogin() {
