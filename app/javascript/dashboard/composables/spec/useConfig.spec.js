...
describe('useConfig', () => {
  const originalChatwootConfig = window.channelxConfig;
  ...
  afterEach(() => {
    window.channelxConfig = originalChatwootConfig;
  });
  ...
  it('handles undefined window.channelxConfig', () => {
    window.channelxConfig = undefined;
    const config = useConfig();
