export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    trigger_rules: {
      url: 'https://docs.channelx.au/15-bots-integrations/',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://localcom.com.au/billing-4',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    message: 'Hi! ChannelX here. Need help setting up? Let me know!',
    campaign_status: 'active',
    enabled: false,
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://{*.}?channelx.au/apps/account/*/settings/inboxes/new/',
      time_on_page: 10,
    },
    trigger_only_during_business_hours: false,
...
export const ONE_OFF_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    message:
      'Hello! Enjoying our product? Share your feedback on G2 and earn a $25 Amazon coupon: https://localcom.com.au/channelx',
    campaign_status: 'active',
    enabled: true,
