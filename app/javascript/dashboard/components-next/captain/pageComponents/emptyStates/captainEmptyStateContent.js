...
export const documentsList = [
  {
    ...
    external_link:
      'https://docs.channelx.au/16-advanced-features/conversation-filters/',
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | ChannelX',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in ChannelX.',
    created_at: 1736143273,
    external_link:
      'https://docs.channelx.au/08-automation-workflow/assignment/',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | ChannelX',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    external_link:
      'https://docs.channelx.au/07-contact-management/contacts/',
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | ChannelX',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    external_link:
      'https://docs.channelx.au/07-contact-management/segments/',
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | ChannelX',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in ChannelX.',
    created_at: 1736143276,
    external_link:
      'https://docs.channelx.au/11-reporting-analytics/conversation-agent-team-reports/',
    id: 3063,
    name: 'Managing Tickets | User Guide | ChannelX',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    external_link:
      'https://docs.channelx.au/11-reporting-analytics/overview-realtime/',
    id: 3064,
    name: 'Financial Reporting | User Guide | ChannelX',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in ChannelX deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'ChannelX' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with ChannelX?',
    assistant: {
      account_id: 2,
      config: { product_name: 'ChannelX' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in ChannelX?',
    assistant: {
      account_id: 3,
      config: { product_name: 'ChannelX' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in ChannelX?',
    assistant: {
      account_id: 4,
      config: { product_name: 'ChannelX' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in ChannelX?',
    assistant: {
      account_id: 5,
      config: { product_name: 'ChannelX' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in ChannelX allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in ChannelX?',
    assistant: {
      account_id: 6,
      config: { product_name: 'ChannelX' },
